...
- Detects items in user-uploaded images
- Search events by theme/category and get curated visuals
- Logged-in users can save, edit, and share event plans
- View saved events, preferences, and past interactions

## Tech Stack :
- Frontend : React, HTML, CSS, JavaScript, JWT + bcrypt
- Backend : Node.js, Express.js, MongoDB, OpenAI/Gemini API
